...
export default function EmployeeListPage() {
  ...
  if (!employees?.length) return <EmptyState message="No employees found" actionLabel="Create Employee" onAction={() => navigate("/employees/new")} />;

  return (
    <div>
      <PageHeader title="Employees" description="Manage employees" actionLabel="Create Employee" onAction={() => navigate("/employees/new")} />
      <DataTable
        columns={[
          ...
          { key: "id", header: "Actions", render: (e: EmployeeResponse) => (
